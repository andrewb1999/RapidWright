...
public class VersalTimingReport {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.printf("phases (ms): hier nets %d, constants %d, logic arcs %d, net edges %d, clock seeding %d, arrivals %d, slack %d%n",
                g.hierNetsMs, g.phaseMs[0], g.phaseMs[1], g.phaseMs[2], sa.phaseMs[0], sa.phaseMs[1], sa.phaseMs[2]);
