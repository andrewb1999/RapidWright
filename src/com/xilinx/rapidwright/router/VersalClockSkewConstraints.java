...
public class VersalClockSkewConstraints {
    ...
    /**
     * Supplies the clock skew between two placed registers' sites, in ps, or null when the
     * model cannot price the pair. Any clock model can back this; the timing.versal slack
     * analysis prices it from the routed clock tree.
     */
    @FunctionalInterface
    public interface SkewSource {
        Integer getSkewPs(Site launch, Site capture, boolean setup);
    }
    ...
    public static Result build(Design design, SkewSource model) {
     ...
     */
    public static Result build(Design design, SkewSource model, int maxLogicDepth,
                               boolean setup) {
